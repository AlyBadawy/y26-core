...
RSpec.describe "Api::V1::GratitudeEntries", type: :request do
  ...
  describe "GET /index" do
    it "returns entries in the date range ordered ascending" do
      ...
      get api_v1_gratitude_entries_url, params: { start_date: "2025-12-30", end_date: "2026-01-01" }, headers: @headers
    ...
    it "returns bad_request for invalid date params" do
      get api_v1_gratitude_entries_url, params: { start_date: "bad", end_date: "also_bad" }, headers: @headers
  ...
  describe "GET /show" do
    it "returns the requested gratitude entry" do
      ...
      get api_v1_gratitude_entry_url(entry.id), headers: @headers
      expect(response).to have_http_status(:ok)
      body = JSON.parse(response.body)
  ...
  describe "authentication" do
    it_behaves_like "unauthorized request", :get, -> { api_v1_gratitude_entries_url(start_date: "2025-12-01", end_date: "2025-12-31") }, :no_token
    it_behaves_like "unauthorized request", :get, -> { api_v1_gratitude_entries_url(start_date: "2025-12-01", end_date: "2025-12-31") }, :invalid_token

    it_behaves_like "unauthorized request", :get, -> { api_v1_gratitude_entry_url(1) }, :no_token
    it_behaves_like "unauthorized request", :get, -> { api_v1_gratitude_entry_url(1) }, :invalid_token
    it_behaves_like "unauthorized request", :post, -> { api_v1_gratitude_entries_url }, :no_token
    it_behaves_like "unauthorized request", :post, -> { api_v1_gratitude_entries_url }, :invalid_token

    it_behaves_like "unauthorized request", :put, -> { api_v1_gratitude_entry_url(1) }, :no_token
    it_behaves_like "unauthorized request", :put, -> { api_v1_gratitude_entry_url(1) }, :invalid_token
    it_behaves_like "unauthorized request", :delete, -> { api_v1_gratitude_entry_url(1) }, :no_token
    it_behaves_like "unauthorized request", :delete, -> { api_v1_gratitude_entry_url(1) }, :invalid_token
  end
end
